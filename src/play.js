...
var PlayMenu = util.extend(Object, 'PlayMenu', {
  constructor: function PlayMenu(game, onUpdate, onModeSwitch,
    onGravityChange) {
    this.background = game.add.sprite(0, 0, 'image/background');
    this.score = game.add.text(0, 0, 'Gravity: ');
  ...
  updateGuiMode: function updateGuiMode() {
    this.score.visible = this.mode === MODES.physical;
  },
  ...
  gravityChange: function gravityChange(mass) {
    this.score.text = 'Gravity: ' + Math.round(mass);
  }
});
